...
import de.computerlyrik.spring.securityobjects.example.web.converter.ItemConverter;
...
privileged aspect ItemConverter_Roo_Converter {
    ...
    declare @type: ItemConverter: @FacesConverter("de.computerlyrik.spring.securityobjects.example.web.converter.ItemConverter");
