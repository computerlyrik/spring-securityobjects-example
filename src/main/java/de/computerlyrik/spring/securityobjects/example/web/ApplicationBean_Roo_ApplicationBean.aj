...
import de.computerlyrik.spring.securityobjects.example.web.ApplicationBean;
...
privileged aspect ApplicationBean_Roo_ApplicationBean {
    ...
    public void ApplicationBean.init() {
        ...
        submenu = new Submenu();
        submenu.setId("categorySubmenu");
        submenu.setLabel("Category");
        item = new MenuItem();
        item.setId("createCategoryMenuItem");
        item.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{messages.label_create}", String.class));
        item.setActionExpression(expressionFactory.createMethodExpression(elContext, "#{categoryBean.displayCreateDialog}", String.class, new Class[0]));
        ...
        item = new MenuItem();
        item.setId("listCategoryMenuItem");
        item.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{messages.label_list}", String.class));
        item.setActionExpression(expressionFactory.createMethodExpression(elContext, "#{categoryBean.displayList}", String.class, new Class[0]));
