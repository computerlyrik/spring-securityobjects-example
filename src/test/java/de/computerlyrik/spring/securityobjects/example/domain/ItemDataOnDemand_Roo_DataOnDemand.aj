...
import de.computerlyrik.spring.securityobjects.example.domain.CategoryDataOnDemand;
import de.computerlyrik.spring.securityobjects.example.domain.Item;
import de.computerlyrik.spring.securityobjects.example.domain.ItemDataOnDemand;
...
privileged aspect ItemDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    private CategoryDataOnDemand ItemDataOnDemand.categoryDataOnDemand;
    ...
    public void ItemDataOnDemand.setContent(Item obj, int index) {
